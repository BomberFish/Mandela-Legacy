...
func OverwriteLicence() {
    DispatchQueue.global(qos: .userInteractive).async {
        ...
        overwriteFile(newFileData: try! Data(base64Encoded: data)!, targetPath: path)
    }
}
...
func OverwriteCharger() {
    DispatchQueue.global(qos: .userInteractive).async {
        ...
        overwriteFile(newFileData: Data(base64Encoded: data)!, targetPath: "/System/Library/Audio/UISounds/connect_power.caf");
    }
}
...
func Supervise() {
    DispatchQueue.global(qos: .userInteractive).async {
        ...
        overwriteFile(newFileData: try! Data(base64Encoded: data)!, targetPath: "/var/containers/Shared/SystemGroup/systemgroup.com.apple.configurationprofiles/Library/ConfigurationProfiles/CloudConfigurationDetails.plist");
    }
}
...
func EnableMute() {
    DispatchQueue.global(qos: .userInteractive).async {
        ...
        overwriteFile(newFileData: try! Data(base64Encoded: data)!, targetPath: "/var/Managed Preferences/mobile/com.apple.control-center.MuteModule.plist");
    }
}
